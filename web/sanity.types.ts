...
// Query: *[_type == "homePage"][0]{  _id,  title,  hero{    headline,    subtitle,    image{      asset->{        _id,        url      },      alt,      hotspot    },    images[]{      // new slide object: { image, mobileImage }      image{ asset->{ _id, url }, alt, hotspot },      mobileImage{ asset->{ _id, url }, alt, hotspot }    },    logo{      asset->{        _id,        url      },      alt,      hotspot    },    mobileLogo{      asset->{        _id,        url      },      alt,      hotspot    }  },  pageBuilder[]{    _type,    _key,    _type == "infoSection" => {      title,      content,      image{        asset->{          _id,          url        },        alt,        hotspot      }    },    _type == "callToAction" => {      title,      content,      button{        text,          _type == "link" => {    "page": page->slug.current,    "post": post->slug.current  }      }    }  },  seo{    metaDescription,    ogImage{      asset->{        _id,        url      }    }  }}
